      ...
      <v-row class="renglon">   
        ...
        <v-dialog v-model="openDialogErase" width="500" height="500" persistent>
            <v-card>
                ...
                <v-card-text>¿Realmente lo quieres borrar?</v-card-text>
                <v-card-actions>
                    <v-btn color="red" @click="openDialogErase = false">
                        Cancelar
                    </v-btn>
                    
                    <v-btn color="warning" @click="eraseUser">
                        Borrar
                    </v-btn>
                </v-card-actions>
            </v-card>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            dialogUser( item ) {
                this.idEraseUser = item._id // GUARDAR VARIABLE
